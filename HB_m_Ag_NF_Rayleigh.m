...
xlswrite(file_name,Row0,'mass flow','A1');
xlswrite(file_name,Row1,'mass flow','A2');
xlswrite(file_name,m_flow','mass flow','A3');
xlswrite(file_name,P_el','mass flow','B3');
xlswrite(file_name,P_th','mass flow','C3');
xlswrite(file_name,Tout','mass flow','D3');
xlswrite(file_name,ef_el','mass flow','E3');
xlswrite(file_name,ef_th','mass flow','F3');
