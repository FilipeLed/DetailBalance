...
xlswrite(file_name,Row0,'Diameter','A1');
xlswrite(file_name,Row1,'Diameter','A2');
xlswrite(file_name,D','Diameter','A3');
xlswrite(file_name,P_el','Diameter','B3');
xlswrite(file_name,P_th','Diameter','C3');
xlswrite(file_name,Tout','Diameter','D3');
xlswrite(file_name,ef_el','Diameter','E3');
xlswrite(file_name,ef_th','Diameter','F3');
