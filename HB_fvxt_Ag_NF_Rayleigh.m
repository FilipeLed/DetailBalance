...
%4.1 STEP
%DATA EXTRACTION FROM TABLES
data1 = xlsread('OpticalData.xlsx','Rayleigh','A3:B820');
...
False = 0;
xlCenter = -4108;
Row0 = {'Silver fvxt P_th',NaN,NaN,NaN,NaN,NaN,NaN};
Row1 = {'fv/t_nf'};
Row2 = {'Silver fvxt P_el',NaN,NaN,NaN,NaN};
Row3 = {'Silver fvxt Tout',NaN,NaN,NaN,NaN};
Row4 = {'Silver fvxt ef_el',NaN,NaN,NaN,NaN};
Row5 = {'Silver fvxt ef_th',NaN,NaN,NaN,NaN};
%directoryname = uigetdir('', 'Escolha uma pasta para salvar o arquivo');
file_name = fullfile(directoryname,'Artigo_Rayleigh.xlsx');
xlswrite(file_name,Row0,'Ag fvxt Pth','A1');
xlswrite(file_name,Row1,'Ag fvxt Pth','A2');
xlswrite(file_name,fv','Ag fvxt Pth','A3');
xlswrite(file_name,t_nf,'Ag fvxt Pth','B2');
xlswrite(file_name,P_th','Ag fvxt Pth','B3');

xlswrite(file_name,Row2,'Ag fvxt Pel','A1');
xlswrite(file_name,Row1,'Ag fvxt Pel','A2');
xlswrite(file_name,fv','Ag fvxt Pel','A3');
xlswrite(file_name,t_nf,'Ag fvxt Pel','B2');
xlswrite(file_name,P_el','Ag fvxt Pel','B3');

xlswrite(file_name,Row3,'Ag fvxt Tout','A1');
xlswrite(file_name,Row1,'Ag fvxt Tout','A2');
xlswrite(file_name,fv','Ag fvxt Tout','A3');
xlswrite(file_name,t_nf,'Ag fvxt Tout','B2');
xlswrite(file_name,Tout','Ag fvxt Tout','B3');

xlswrite(file_name,Row4,'Ag fvxt efel','A1');
xlswrite(file_name,Row1,'Ag fvxt efel','A2');
xlswrite(file_name,fv','Ag fvxt efel','A3');
xlswrite(file_name,t_nf,'Ag fvxt efel','B2');
xlswrite(file_name,ef_el','Ag fvxt efel','B3');

xlswrite(file_name,Row5,'Ag fvxt efth','A1');
xlswrite(file_name,Row1,'Ag fvxt efth','A2');
xlswrite(file_name,fv','Ag fvxt efth','A3');
xlswrite(file_name,t_nf,'Ag fvxt efth','B2');
xlswrite(file_name,ef_th','Ag fvxt efth','B3');
