...
xlswrite(file_name,Row0,'thickness','G1');
xlswrite(file_name,Row1,'thickness','G2');
xlswrite(file_name,t_nf','thickness','G3');
xlswrite(file_name,P_el','thickness','H3');
xlswrite(file_name,P_th','thickness','I3');
xlswrite(file_name,Tout','thickness','J3');
xlswrite(file_name,ef_el','thickness','K3');
xlswrite(file_name,ef_th','thickness','L3');
